...
input string CLIENT_NAME = "trader013"; // Client Name
input string USER_ID = "25"; // Your User ID from registration
input string LICENSE_KEY = "85b7791364cc4ea0bff41af5d2a04ce3c9146dc0b20c2c682002e11ba56b81d7"; // Your License Key
input string BROKER_NAME = "PUPrime"; // Your Broker
input string ACCOUNT_NUMBER = "159486001"; // Your Account Number
...
input string WEBHOOK_URL = "http://localhost:3000/api/webhook/25/85b7791364cc4ea0bff41af5d2a04ce3c9146dc0b20c2c682002e11ba56b81d7"; // Your Webhook URL
...
int OnInit()
{
    ...
    if(USER_ID == "25" || LICENSE_KEY == "85b7791364cc4ea0bff41af5d2a04ce3c9146dc0b20c2c682002e11ba56b81d7")
    {
    ...
    if(ACCOUNT_NUMBER != "159486001" && currentAccount != ACCOUNT_NUMBER)
    {
