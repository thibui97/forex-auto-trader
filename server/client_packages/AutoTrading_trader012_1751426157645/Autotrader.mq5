...
input string CLIENT_NAME = "trader012"; // Client Name
input string USER_ID = "24"; // Your User ID from registration
input string LICENSE_KEY = "c48f3ec4d887e80111b8e73e74bf1572b7340cbd62d3c607d433f684e9afadc2"; // Your License Key
input string BROKER_NAME = "PUPrime"; // Your Broker
input string ACCOUNT_NUMBER = "14825056"; // Your Account Number
...
input string WEBHOOK_URL = "http://localhost:3000/api/webhook/24/c48f3ec4d887e80111b8e73e74bf1572b7340cbd62d3c607d433f684e9afadc2"; // Your Webhook URL
...
int OnInit()
{
    ...
    if(USER_ID == "24" || LICENSE_KEY == "c48f3ec4d887e80111b8e73e74bf1572b7340cbd62d3c607d433f684e9afadc2")
    {
    ...
    if(ACCOUNT_NUMBER != "14825056" && currentAccount != ACCOUNT_NUMBER)
    {
