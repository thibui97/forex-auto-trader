...
input string CLIENT_NAME = "trader010"; // Client Name
input string USER_ID = "23"; // Your User ID from registration
input string LICENSE_KEY = "8939a68a2d52cd6be12c729fbeaa4187fe6fe32f23ff063b95249e9f44ccdb9f"; // Your License Key
input string BROKER_NAME = "PUPrime"; // Your Broker
input string ACCOUNT_NUMBER = "2345377834"; // Your Account Number
...
input string WEBHOOK_URL = "http://localhost:3000/api/webhook/23/8939a68a2d52cd6be12c729fbeaa4187fe6fe32f23ff063b95249e9f44ccdb9f"; // Your Webhook URL
...
int OnInit()
{
    ...
    if(USER_ID == "23" || LICENSE_KEY == "8939a68a2d52cd6be12c729fbeaa4187fe6fe32f23ff063b95249e9f44ccdb9f")
    {
    ...
    if(ACCOUNT_NUMBER != "2345377834" && currentAccount != ACCOUNT_NUMBER)
    {
