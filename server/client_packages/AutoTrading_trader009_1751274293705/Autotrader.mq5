...
input string CLIENT_NAME = "trader009"; // Client Name
input string USER_ID = "22"; // Your User ID from registration
input string LICENSE_KEY = "b819fc7721eb89e1b194f00507f8b6c7dadc261c1ac7b52e343f306261d1b18f"; // Your License Key
input string BROKER_NAME = "EXNESS"; // Your Broker
input string ACCOUNT_NUMBER = "4563783452"; // Your Account Number
...
input string WEBHOOK_URL = "http://localhost:3000/api/webhook/22/b819fc7721eb89e1b194f00507f8b6c7dadc261c1ac7b52e343f306261d1b18f"; // Your Webhook URL
...
int OnInit()
{
    ...
    if(USER_ID == "22" || LICENSE_KEY == "b819fc7721eb89e1b194f00507f8b6c7dadc261c1ac7b52e343f306261d1b18f")
    {
    ...
    if(ACCOUNT_NUMBER != "4563783452" && currentAccount != ACCOUNT_NUMBER)
    {
