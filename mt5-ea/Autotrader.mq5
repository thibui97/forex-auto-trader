...
//| Pre-configured for: USERNAME_PLACEHOLDER                        |
//+------------------------------------------------------------------+
...
input string CLIENT_NAME = "USERNAME_PLACEHOLDER"; // Client Name
input string USER_ID = "USER_ID_PLACEHOLDER"; // Your User ID from registration
input string LICENSE_KEY = "LICENSE_KEY_PLACEHOLDER"; // Your License Key
input string BROKER_NAME = "BROKER_PLACEHOLDER"; // Your Broker
input string ACCOUNT_NUMBER = "ACCOUNT_PLACEHOLDER"; // Your Account Number
...
input string WEBHOOK_URL = "WEBHOOK_URL_PLACEHOLDER"; // Your Webhook URL
...
int OnInit()
{
    ...
    if(USER_ID == "USER_ID_PLACEHOLDER" || LICENSE_KEY == "LICENSE_KEY_PLACEHOLDER")
    {
    ...
    if(ACCOUNT_NUMBER != "ACCOUNT_PLACEHOLDER" && currentAccount != ACCOUNT_NUMBER)
    {
